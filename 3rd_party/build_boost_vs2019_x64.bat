...
b2.exe --toolset=msvc-14.2 --clean-all
b2.exe --toolset=msvc-14.2 architecture=x86 address-model=64 --stagedir=".\stage_x64" threading=multi --build-type=complete stage -j %NUMBER_OF_PROCESSORS%
