...
namespace engine
{
	...
	using flat_model_data = std::tuple<point_buffer, color_buffer, texcoord_buffer, vector_buffer, vector_buffer, vector_buffer>;
	...
	using indexed_model_data = std::tuple<point_buffer, color_buffer, texcoord_buffer, vector_buffer, vector_buffer, vector_buffer, index_buffer>;
